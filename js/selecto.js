...
(function (global, factory) {
    ...
    */
    ...
    var PROPERTIES = ["boundContainer", "selectableTargets", "selectByClick", "selectFromInside", "continueSelect", "toggleContinueSelect", "keyContainer", "hitRate", "scrollOptions", "checkInput", "preventDefault", "ratio", "getElementRect", "preventDragFromInside"];
    /**
     * @memberof Selecto
     */
    ...
    function (_super) {
      ...
      function Selecto(options) {
        ...
        _this.onDragStart = function (e, clickedTarget) {
          ...
          var result = !e.isClick && isTrusted ? _this.trigger("dragStart", __assign({}, e)) : true;
